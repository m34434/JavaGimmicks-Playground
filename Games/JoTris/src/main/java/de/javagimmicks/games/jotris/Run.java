...
//      final JoTrisModel model = new DefaultJoTrisModel(20, 12, QuinTrisTileFactory.getDefaultInstance());
      ...
      // Add the controller part for receiving keyboard commands and auto-pausing
